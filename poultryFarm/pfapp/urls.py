...
urlpatterns = [
    ...
    path('daily-motor-report', views.daily_motor, name='daily_motor'),
    path('daily-bagging-report', views.daily_bagging, name='daily_bagging'),
    ...
    path('shift-motor-report', views.shift_motor, name='shift_motor'),
    path('shift-bagging-report', views.shift_bagging, name='shift_bagging'),
